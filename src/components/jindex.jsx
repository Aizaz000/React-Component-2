...
function index() {
  return (
    <div>
        ...
        <div className="chat-popup shadow" id="hide-in-mobile">
            <div className="row chat-window col-xs-5 col-md-3">
                <div className="col-md-12">
                    <div className="card">
                        <div className="top-bar shadow-sm d-flex align-items-center">
                            <div className="col-md-6 col-xs-6">
                                <a href="profile.html">
                                    <img src="assets/images/users/user-2.jpg" className="mr-2 chatbox-user-img" alt="Chat user image"/>
                                    <span className="panel-title">Karen Minas</span>
                                </a>
                            </div>
                            <div className="col-md-6 col-xs-6 d-flex align-items-center justify-content-between">
                                <a href="#">
                                    <img src="assets/images/icons/messenger/video-call.png" className="chatbox-call" alt="Chatbox contact types"/>
                                </a>
                                <a href="#" data-toggle="modal" data-target="#callModal">
                                    <img src="assets/images/icons/messenger/call.png" className="chatbox-call" alt="Chatbox contact types"/>
                                </a>
                                <a href="javascript:void(0)"><i id="minimize-chat-window" className="bx bx-minus icon_minim"></i></a>
                                <a href="javascript:void(0)" id="close-chatbox"><i className="bx bx-x"></i></a>
                            </div>
                        </div>
                        <div id="messagebody" className="msg_container_base">
                            <div className="row msg_container base_sent">
                                <div className="col-md-10 col-xs-10">
                                    <div className="messages message-reply bg-primary shadow-sm">
                            ...
                            <div className="row msg_container base_receive">
                                <div className="col-md-10 col-xs-10">
                                    <div className="messages message-receive shadow-sm">
                        ...
                        <div className="card-footer chat-inputs">
                            <div className="col-md-12 message-box">
                                <input type="text" className="w-100 search-input type-message" placeholder="Type a message..." />
                                <div className="chat-tools">
                                    <a href="#" className="chatbox-tools">
                                        <img src="assets/images/icons/theme/post-image.png" className="chatbox-tools-img" alt="Chatbox tool"/>
                                    </a>
                                    <a href="#" className="chatbox-tools">
                                        <img src="assets/images/icons/messenger/gif.png" className="chatbox-tools-img" alt="Chatbox tool"/>
                                    </a>
                                    <a href="#" className="chatbox-tools">
                                        <img src="assets/images/icons/messenger/smile.png" className="chatbox-tools-img" alt="Chatbox tool"/>
                                    </a>
                                    <a href="#" className="chatbox-tools">
                                        <img src="assets/images/icons/messenger/console.png" className="chatbox-tools-img" alt="Chatbox tool"/>
                                    </a>
                                    <a href="#" className="chatbox-tools">
                                        <img src="assets/images/icons/messenger/attach-file.png" className="chatbox-tools-img" alt="Chatbox tool"/>
                                    </a>
                                    <a href="#" className="chatbox-tools">
                                        <img src="assets/images/icons/messenger/photo-camera.png" className="chatbox-tools-img" alt="Chatbox tool"/>
                                    </a>
                                </div>
                            </div>
                        </div>
